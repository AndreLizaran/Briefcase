...
function Technologies() {
  return (
    <section>
      <h1
        className='text-xl mb-1 text-gray-300 md:text-right mb-3'
...
function Projects() {
  return (
    <section className='mt-6'>
      <h1 className='text-xl mb-3 text-gray-300' id='projects-title'>
        Projects
      </h1>
...
function Experience() {
  return (
    <section className='mt-6'>
      <h1 className='text-xl mb-3 text-gray-300' id='experience-title'>
        Experience
      </h1>
...
function ContactMe() {
  return (
    <section className='mt-6'>
      <h1 className='text-xl mb-3 text-gray-300' id='contact-me-title'>
        Contact Me
      </h1>
